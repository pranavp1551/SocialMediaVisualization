...
/**
 * This is the test class for DLList
 * This was pulled from lab 10
 *
 * @author Eric
 * @author maellis1
 * @author vfolomeev
...
public class DLListTest extends TestCase {
    ...
    /**
     * This method runs once before every test
     */
    @Override
    public void setUp() {
    ...
    /**
     * Tests the next method for the iterator
     */
    public void testIteratorNext() {
        ...
        list.add("Yes");
        assertEquals("Yes", iter.next());
    }

    /**
     * This method tests the insertionSort method and makes sure it correctly
     * sorts the data in the linked list
     */
    public void testInsertionSort() {
        ...
        DLList<Bar> users = new DLList<Bar>();

        users.add(new Bar("B", 342));
        users.add(new Bar("D", 451));
        users.add(new Bar("A", 857));
        users.add(new Bar("C", 372));

        users.insertionSort(new StringComparator());
        users.insertionSort(new ValueComparator());
    }
